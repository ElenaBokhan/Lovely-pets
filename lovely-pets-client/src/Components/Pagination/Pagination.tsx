...
export const Pagination = ({currentPage, total}: IPaginationProps) => {
    ...
    const handlePrevPage = () => {
        petsListFilterStore.setState((prev) => ({...prev, pagination: currentPage - 1}));
    };
    ...
    const handleDotsPage = () => {
        const paginationValue = currentPage < lastIndexPage - MIDDLE_INDEX_PAGE ? currentPage + 1 : currentPage - 1;
        petsListFilterStore.setState((prev) => ({...prev, pagination: paginationValue}));
    };

    const handlePageItemsClick = (page: number) => {
        petsListFilterStore.setState((prev) => ({...prev, pagination: page}));
    };
